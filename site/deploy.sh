...
aws s3 cp --cache-control max-age=86400 cat-logo.png s3://joseki.milescrawford.com/
aws s3 cp --cache-control max-age=86400 manifest.json s3://joseki.milescrawford.com/
